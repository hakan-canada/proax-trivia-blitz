...
export const LanguageSelector: React.FC<LanguageSelectorProps> = ({
  ...
  return <div className="min-h-screen bg-gradient-to-br from-proax-bg to-white flex items-center justify-center p-4">
      <Card className="w-full max-w-2xl p-8 md:p-12 text-center shadow-2xl animate-fade-in">
        ...
        <div className="mb-8">
          <div className="w-48 h-32 mx-auto mb-6 flex items-center justify-center">
            <img src="https://3958257.fs1.hubspotusercontent-na1.net/hubfs/3958257/Email%20logo-1.png" alt="Proax Logo" className="max-w-full max-h-full object-contain" onError={e => {
