...
const defaultQuestions: Question[] = [
  ...
  {
    id: '4',
    questionText: 'Which of the following is NOT something Proax offers?',
    questionTextFr: 'Lequel des éléments suivants n\'est PAS quelque chose que Proax offre?',
    questionType: 'multiple',
    options: ['Industrial Communication & Networking', 'Extrusions', 'Cleaning Supplies', 'Machine Safety'],
    optionsFr: ['Communication et réseautage industriels', 'Extrusions', 'Produits de nettoyage', 'Sécurité des machines'],
    correctAnswer: 'Cleaning Supplies',
    correctAnswerFr: 'Produits de nettoyage',
    points: 20,
  },
  {
    id: '5',
